...
const file_rbe_auxiliary_metadata_proto_rawDesc = "" +
	"\n" +
	"\x1crbe_auxiliary_metadata.proto\x120devtools_foundry_api_remote_execution_extensions\"{\n" +
	"\bVersions\x12\x19\n" +
	"\bvm_image\x18\x01 \x01(\tR\avmImage\x12(\n" +
	"\x10bot_code_version\x18\x02 \x01(\tR\x0ebotCodeVersion\x12*\n" +
	"\x11docker_root_image\x18\x03 \x01(\tR\x0fdockerRootImage\"\xe7\x01\n" +
	"\rResourceUsage\x12.\n" +
	"\x13cpu_percentage_peak\x18\x01 \x01(\x01R\x11cpuPercentagePeak\x124\n" +
	"\x16cpu_percentage_average\x18\x02 \x01(\x01R\x14cpuPercentageAverage\x124\n" +
	"\x16memory_percentage_peak\x18\x03 \x01(\x01R\x14memoryPercentagePeak\x12:\n" +
	"\x19memory_percentage_average\x18\x04 \x01(\x01R\x17memoryPercentageAverage\"\xd6\x01\n" +
	"\x11AuxiliaryMetadata\x12V\n" +
	"\bversions\x18\x01 \x01(\v2:.devtools_foundry_api_remote_execution_extensions.VersionsR\bversions\x12\x12\n" +
	"\x04pool\x18\x02 \x01(\tR\x04pool\x12U\n" +
	"\x05usage\x18\x03 \x01(\v2?.devtools_foundry_api_remote_execution_extensions.ResourceUsageR\x05usageB(Z&go.chromium.org/build/siso/reapi/protob\x06proto3"
