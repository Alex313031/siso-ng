...
const file_manifest_proto_rawDesc = "" +
	"\n" +
	"\x0emanifest.proto\x12\bmanifest\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x91\x01\n" +
	"\bManifest\x123\n" +
	"\x05files\x18\x01 \x03(\v2\x1d.manifest.Manifest.FilesEntryR\x05files\x1aP\n" +
	"\n" +
	"FilesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.manifest.FileManifestR\x05value:\x028\x01\"\x89\x02\n" +
	"\fFileManifest\x12(\n" +
	"\x06digest\x18\x01 \x01(\v2\x10.manifest.DigestR\x06digest\x12\x12\n" +
	"\x04path\x18\x02 \x01(\tR\x04path\x12#\n" +
	"\ris_executable\x18\x03 \x01(\bR\fisExecutable\x12,\n" +
	"\x12is_empty_directory\x18\x04 \x01(\bR\x10isEmptyDirectory\x12%\n" +
	"\x0esymlink_target\x18\x05 \x01(\tR\rsymlinkTarget\x12A\n" +
	"\x0fnode_properties\x18\x06 \x01(\v2\x18.manifest.NodePropertiesR\x0enodeProperties\"\xb5\x01\n" +
	"\x0eNodeProperties\x126\n" +
	"\n" +
	"properties\x18\x01 \x03(\v2\x16.manifest.NodePropertyR\n" +
	"properties\x120\n" +
	"\x05mtime\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x05mtime\x129\n" +
	"\tunix_mode\x18\x03 \x01(\v2\x1c.google.protobuf.UInt32ValueR\bunixMode\"8\n" +
	...
	"\n" +
	"size_bytes\x18\x02 \x01(\x03R\tsizeBytesBAZ?go.chromium.org/build/siso/toolsupport/artfsutil/proto/manifestb\x06proto3"
